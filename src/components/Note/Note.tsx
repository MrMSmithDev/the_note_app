...
const Note: React.FC<NoteProps> = ({ date }) => {
  ...
  return (
    <div className="bg-background dark:bg-background-dark rounded shadow-md p-5 min-w-[300px] w-min">
      ...
      <form className="flex gap-2 flex-col md:flex-row justify-center mt-2">
        ...
        <input
          className="p-1 border-2 border-gray-200 focus:outline-gray-400 text-sm tracking-wide min-w-[200px]"
          type="text"
          id="newNote"
          name="newNote"
