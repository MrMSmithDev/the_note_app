    ...
    <main className="h-[calc(100lvh-48px)] p-5">
      <nav className="flex justify-center px-10 items-center my-5 w-full">
        <button
          ...
          value={-1}
        >
          <ChevronIcon className="h-4 w-4" fill="#ff2c2c" inverted={true} />
        </button>
        <AnimatePresence mode="wait">
          <motion.h1
            ...
            className="text-3xl font-bold font-kanit italics text-transparent bg-clip-text bg-linear-to-tr from-blue-400 to-blue-600 py-2 mx-10"
          >
            {fullYear}
          </motion.h1>
        </AnimatePresence>
        <button
          ...
          value={1}
        >
          <ChevronIcon className="h-4 w-4" fill="#ff2c2c" />
        </button>
      </nav>
